# H1N1 symptom onset data of Thompson et al. 2019
...
pdf(file = "Fig1.pdf", width = 24, height = 8.5)
...
for(i in 2:n){
  lines(siwindowdat[i,1:2], siwindowdat[i,3:4], type = "l", lwd = 3,
        col = "black")
}
...
plot(sfine, sapply(sfine, SIfit$Fhat), type = "l", col = "darkblue",
...
for(b in 1:B){
  lines(sfine, sboot_cdf[b,], type = "l", col = "lightblue")
}
lines(sfine, sapply(sfine, SIfit$Fhat), type = "l", col = "darkblue", lwd = 3)
...
text(x = 0.63, y = 0.8, paste0("SD SI (95% CI): ",
