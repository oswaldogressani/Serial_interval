#------------------------------------------------------------------------------#
#                         Scenario S2 (Smallpox)                               #
#------------------------------------------------------------------------------#
#   -->  Gaussian SI with mean=16.7 and sd=3.3 from Vink et al. (2014)         #
#   -->  Sample size n = 50                                                    #
#   -->  Average coarseness of 3 days                                          #
#------------------------------------------------------------------------------#
...
set.seed(501)
n <- 50
meanSI  <-  16.7  # Vink et al. (2014)
sdSI    <-  3.3   # Vink et al. (2014)
...
for(s in 1:S){
  simdata <- simSI(muS = meanSI, sdS = sdSI, n = n, maxcoarse = 4,
                   probcoarse = c(0.6,0.2,0.1,0.1))
...
print(xtable(perfnonparam, digits = 3, label = "Scenario-S2-Smallpox-n50"), 
      file="Scenario-S2-Smallpox-n50.txt")
